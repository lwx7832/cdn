		...
		*/
		embedSWF: function() {
			...
			if(!this.checkShockwaveFlash()){
				this.PD.innerHTML = '<p>'+this.ckLanguage['buttonOver']['noLoadShockwaveFlash']+'</p><p><a href="http://www.adobe.com/go/getflash" target="_blank" style="color:#FFFFFF">'+this.ckLanguage['buttonOver']['downLoadShockwaveFlash']+'</a></p>';
